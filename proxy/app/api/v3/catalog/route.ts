...
import { V3_DURATIONS, v3Quote, type V3ProductId } from "../../../../lib/v3";
...
export async function GET() {
  return NextResponse.json({
    version: "3.0.0-beta.1", mode: "simulation-only", paymentProtocol: "x402-v2-upto (contract preview; settlement disabled)", realSettlementEnabled: config.v3RealSettlementEnabled,
